...
call compile preprocessFileLineNumbers "DAYZ_CODE\FUNCTIONS\CoinInit.sqf";
call compile preprocessFileLineNumbers "DAYZ_CODE\FUNCTIONS\BankInit.sqf";
